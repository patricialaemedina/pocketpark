...
def my_reservation(request):
    ...
    successful_bookings = Payment.objects.filter(booking__user=request.user, booking__is_valid=False, payment_status="Paid").order_by('-booking__created_at')
    failed_bookings = Payment.objects.filter(booking__user=request.user, booking__is_valid=False, payment_status="Failed").order_by('-booking__created_at')
